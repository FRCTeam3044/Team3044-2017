...
public class GripPipeline implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double[] hslThresholdHue = { 60.63012811008223, 160.27120487977317 };
		double[] hslThresholdSaturation = { 31.210370686501623, 255.0 };
		double[] hslThresholdLuminance = { 197.4625837408946, 255.0 };
		...
		filterContours(filterContoursContours, filterContoursMinArea, filterContoursMinPerimeter, filterContoursMinWidth, filterContoursMaxWidth, filterContoursMinHeight,
				filterContoursMaxHeight, filterContoursSolidity, filterContoursMaxVertices, filterContoursMinVertices, filterContoursMinRatio, filterContoursMaxRatio,
	 ...
	 */
	private void filterContours(List<MatOfPoint> inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight,
			double[] solidity, double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, List<MatOfPoint> output) {
