...
public class Drive {
	...
	public void driveInit() {
		...
		//Creates A Text File On The Robo RIO
		try {
	...
	public void driveTeleopPeriodic() {
		...
		try {
			...
			bw.write(";");
			bw.write((String.valueOf(pdp.getCurrent(14))) + ";" + (String.valueOf(pdp.getCurrent(3))) + ";"
					+ (String.valueOf(pdp.getCurrent(13))) + ";" + (String.valueOf(pdp.getCurrent(12)) + "\n"));
		} catch (IOException e) {
	...
	public void testInit() {
		//Run Test Init For A Few Seconds To Close The File Writer
		try {
			bw.close();
			fw.close();
		} catch (IOException e) {
